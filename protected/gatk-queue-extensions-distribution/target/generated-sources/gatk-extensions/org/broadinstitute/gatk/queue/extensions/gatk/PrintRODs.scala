...
@Input(fullName="input", shortName="input", doc="The input ROD which should be printed out.", required=true, exclusiveOf="", otherArgumentRequired="", validation="")
var input: File = _

/** Dependencies on the index of input */
@Input(fullName="inputIndex", shortName="", doc="Dependencies on the index of input", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
