...
@Input(fullName="knownAlleles", shortName="known", doc="Input VCF file(s) with known indels", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Input(fullName="knownAllelesIndexes", shortName="", doc="Dependencies on any indexes of knownAlleles", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
private var knownAllelesIndexes: Seq[File] = Nil

/** Intervals file output from RealignerTargetCreator */
@Input(fullName="targetIntervals", shortName="targetIntervals", doc="Intervals file output from RealignerTargetCreator", required=true, exclusiveOf="", otherArgumentRequired="", validation="")
var targetIntervals: File = _

/** LOD threshold above which the cleaner will clean */
@Argument(fullName="LODThresholdForCleaning", shortName="LOD", doc="LOD threshold above which the cleaner will clean", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="LODThresholdForCleaningFormat", shortName="", doc="Format string for LODThresholdForCleaning", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
var LODThresholdForCleaningFormat: String = "%s"

/** Output bam */
@Output(fullName="out", shortName="o", doc="Output bam", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="consensusDeterminationModel", shortName="model", doc="Determines how to compute the possible alternate consenses", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="entropyThreshold", shortName="entropy", doc="Percentage of mismatches at a locus to be considered having high entropy (0.0 < entropy <= 1.0)", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="entropyThresholdFormat", shortName="", doc="Format string for entropyThreshold", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
var entropyThresholdFormat: String = "%s"

/** max reads allowed to be kept in memory at a time by the SAMFileWriter */
@Argument(fullName="maxReadsInMemory", shortName="maxInMemory", doc="max reads allowed to be kept in memory at a time by the SAMFileWriter", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="maxIsizeForMovement", shortName="maxIsize", doc="maximum insert size of read pairs that we attempt to realign", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="maxPositionalMoveAllowed", shortName="maxPosMove", doc="Maximum positional move in basepairs that a read can be adjusted during realignment", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="maxConsensuses", shortName="maxConsensuses", doc="Max alternate consensuses to try (necessary to improve performance in deep coverage)", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="maxReadsForConsensuses", shortName="greedy", doc="Max reads used for finding the alternate consensuses (necessary to improve performance in deep coverage)", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="maxReadsForRealignment", shortName="maxReads", doc="Max reads allowed at an interval for realignment", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="noOriginalAlignmentTags", shortName="noTags", doc="Don't output the original cigar or alignment start tags for each realigned read in the output bam", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="nWayOut", shortName="nWayOut", doc="Generate one output file for each input (-I) bam file (not compatible with -output)", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
var nWayOut: String = _

/** Generate md5sums for BAMs */
@Argument(fullName="generate_nWayOut_md5s", shortName="", doc="Generate md5sums for BAMs", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
var generate_nWayOut_md5s: Boolean = _

/** Do early check of reads against existing consensuses */
@Argument(fullName="check_early", shortName="check_early", doc="Do early check of reads against existing consensuses", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="noPGTag", shortName="noPG", doc="Don't output the usual PG tag in the realigned bam file header. FOR DEBUGGING PURPOSES ONLY.  This option is required in order to pass integration tests.", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="keepPGTags", shortName="keepPG", doc="Keep older PG tags left in the bam header by previous runs of this tool (by default, all these historical tags will be replaced by the latest tag generated in the current run).", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Output(fullName="indelsFileForDebugging", shortName="indels", doc="Output file (text) for the indels found; FOR DEBUGGING PURPOSES ONLY", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Output(fullName="statisticsFileForDebugging", shortName="stats", doc="print out statistics (what does or doesn't get cleaned); FOR DEBUGGING PURPOSES ONLY", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
@Gather(classOf[org.broadinstitute.gatk.queue.function.scattergather.SimpleTextGatherFunction])
...
@Output(fullName="SNPsFileForDebugging", shortName="snps", doc="print out whether mismatching columns do or don't get cleaned out; FOR DEBUGGING PURPOSES ONLY", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
@Gather(classOf[org.broadinstitute.gatk.queue.function.scattergather.SimpleTextGatherFunction])
