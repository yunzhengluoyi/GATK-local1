...
@Input(fullName="beforeReportFile", shortName="before", doc="file containing the BQSR first-pass report file", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Input(fullName="afterReportFile", shortName="after", doc="file containing the BQSR second-pass report file", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="ignoreLastModificationTimes", shortName="ignoreLMT", doc="do not emit warning messages related to suspicious last modification time order of inputs", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Output(fullName="plotsReportFile", shortName="plots", doc="location of the output report", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Output(fullName="intermediateCsvFile", shortName="csv", doc="location of the csv intermediate file", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
@Gather(classOf[org.broadinstitute.gatk.queue.function.scattergather.SimpleTextGatherFunction])
