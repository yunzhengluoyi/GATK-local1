...
@Argument(fullName="include_unmapped", shortName="u", doc="Include unmapped reads in the analysis", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="skip", shortName="skip", doc="Do not print all reads, skip some.", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
