...
@Argument(fullName="dontTrimAlleles", shortName="notrim", doc="Do not Trim alleles to remove bases common to all of them", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="splitMultiallelics", shortName="split", doc="Split multiallelic records and left-align individual alleles", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
override def commandLine = super.commandLine + required(TaggedFile.formatCommandLineParameter("-V", variant), variant, spaceSeparated=true, escape=true, format="%s") + conditional(dontTrimAlleles, "-notrim", escape=true, format="%s") + conditional(splitMultiallelics, "-split", escape=true, format="%s") + conditional(keepOriginalAC, "-keepOriginalAC", escape=true, format="%s") + optional("-o", out, spaceSeparated=true, escape=true, format="%s") + conditional(filter_reads_with_N_cigar, "-filterRNC", escape=true, format="%s") + conditional(filter_mismatching_base_and_quals, "-filterMBQ", escape=true, format="%s") + conditional(filter_bases_not_stored, "-filterNoBases", escape=true, format="%s")
}
