...
*               2-7 November 2010, 2 January 2011, 20 January 2011
*
*   DOCUMENTATION:
...
public class Regression{
    ...
    public ArrayList<Object> polynomialBest(double fixedIntercept, int flag){
        ...
        reg.linear(fixedIntercept);
        chi0 = reg.getChiSquare();
        reg.polynomial(2, fixedIntercept);
        chi1 = reg.getChiSquare();
        arrayl = Regression.testOfAdditionalTerms_ArrayList(chi0, nDeg0, chi1, nDeg1, nData);
        fRatio = (Double)arrayl.get(0);
        fProb = (Double)arrayl.get(1);
        array2.add(new Integer(nDeg0));
        array2.add(new Integer(nDeg1));
            ...
            if(chi1==0.0){
                ...
                if(fProb>this.fProbSignificance){
                    ...
                    while(test){
                        ...
                        nDeg1 = nDeg0+1;
                        chi0 = chi1;
                        reg.polynomial(nDeg1, fixedIntercept);
                        chi1 = reg.getChiSquare();
                        arrayl = Regression.testOfAdditionalTerms_ArrayList(chi0, nDeg0, chi1, nDeg1, nData);
                        fRatio = (Double)arrayl.get(0);
                        fProb = (Double)arrayl.get(1);
        ...
        case 0: // No plot
                ...
                case 1: this.linear();
                break;
                default: this.polynomial(this.bestPolynomialDegree, fixedIntercept);
                }
        break;
        case 1: // Plot
                switch(this.bestPolynomialDegree){
                ...
                case 1: this.linearPlot();
                break;
                default: this.polynomialPlot(this.bestPolynomialDegree, fixedIntercept);
                }
        }
    ...
    protected void generalLinearStats(double[][] xd){
        ...
        this.adjustedR = 1.0 - (1.0 - multR)*(this.nData - 1 )/(this.nData - this.nXarrays - 1);

        // F-ratio
        this.multipleF = multR*(this.nData-this.nXarrays-1.0)/((1.0D-this.multR)*this.nXarrays);
