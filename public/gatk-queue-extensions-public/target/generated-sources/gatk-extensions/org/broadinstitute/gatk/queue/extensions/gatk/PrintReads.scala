...
@Argument(fullName="readGroup", shortName="readGroup", doc="Exclude all reads with this read group from the output", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
var readGroup: String = _

/** Exclude all reads with this platform from the output */
@Argument(fullName="platform", shortName="platform", doc="Exclude all reads with this platform from the output", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
var platform: String = _

/** Print the first n reads from the file, discarding the rest */
@Argument(fullName="number", shortName="n", doc="Print the first n reads from the file, discarding the rest", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="sample_file", shortName="sf", doc="File containing a list of samples (one per line). Can be specified multiple times", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="sample_name", shortName="sn", doc="Sample name to be included in the analysis. Can be specified multiple times.", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
/** Simplify all reads */
@Argument(fullName="simplify", shortName="s", doc="Simplify all reads", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="no_pg_tag", shortName="npt", doc="Don't output a program tag", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
