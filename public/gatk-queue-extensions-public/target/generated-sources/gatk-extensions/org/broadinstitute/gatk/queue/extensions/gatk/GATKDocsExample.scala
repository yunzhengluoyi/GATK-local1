...
@Argument(fullName="full", shortName="short", doc="Brief summary of argument [~ 80 characters of text]", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
var full: Boolean = _
