...
@Input(fullName="pileup", shortName="pileup", doc="Pileup generated by Samtools", required=true, exclusiveOf="", otherArgumentRequired="", validation="")
var pileup: File = _

/** Dependencies on the index of pileup */
@Input(fullName="pileupIndex", shortName="", doc="Dependencies on the index of pileup", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="continue_after_error", shortName="", doc="Continue after encountering an error", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
