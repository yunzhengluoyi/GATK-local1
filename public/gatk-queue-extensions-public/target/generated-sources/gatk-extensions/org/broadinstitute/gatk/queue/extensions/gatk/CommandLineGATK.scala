...
@Argument(fullName="analysis_type", shortName="T", doc="Name of the tool to run", required=true, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Input(fullName="input_file", shortName="I", doc="Input file containing sequence data (BAM or CRAM)", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="showFullBamList", shortName="", doc="Emit list of input BAM/CRAM files to log", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
var showFullBamList: Boolean = _

/** Number of reads per SAM file to buffer in memory */
@Argument(fullName="read_buffer_size", shortName="rbs", doc="Number of reads per SAM file to buffer in memory", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="read_filter", shortName="rf", doc="Filters to apply to reads before analysis", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="disable_read_filter", shortName="drf", doc="Read filters to disable", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Input(fullName="intervals", shortName="L", doc="One or more genomic intervals over which to operate", required=false, exclusiveOf="intervalsString", otherArgumentRequired="intervalsString", validation="")
...
/** One or more genomic intervals over which to operate */
@Argument(fullName="intervalsString", shortName="L", doc="One or more genomic intervals over which to operate", required=false, exclusiveOf="intervals", otherArgumentRequired="intervals", validation="")
...
@Input(fullName="excludeIntervals", shortName="XL", doc="One or more genomic intervals to exclude from processing", required=false, exclusiveOf="excludeIntervalsString", otherArgumentRequired="excludeIntervalsString", validation="")
...
/** One or more genomic intervals to exclude from processing */
@Argument(fullName="excludeIntervalsString", shortName="XL", doc="One or more genomic intervals to exclude from processing", required=false, exclusiveOf="excludeIntervals", otherArgumentRequired="excludeIntervals", validation="")
...
@Argument(fullName="interval_set_rule", shortName="isr", doc="Set merging approach to use for combining interval inputs", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="interval_merging", shortName="im", doc="Interval merging rule for abutting intervals", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="interval_padding", shortName="ip", doc="Amount of padding (in bp) to add to each interval", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="nonDeterministicRandomSeed", shortName="ndrs", doc="Use a non-deterministic random seed", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="disableDithering", shortName="", doc="Completely eliminates randomized dithering from rank sum tests.", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
var disableDithering: Boolean = _

/** Stop execution cleanly as soon as maxRuntime has been reached */
@Argument(fullName="maxRuntime", shortName="maxRuntime", doc="Stop execution cleanly as soon as maxRuntime has been reached", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
var maxRuntime: Option[Long] = None

/** Unit of time used by maxRuntime */
@Argument(fullName="maxRuntimeUnits", shortName="maxRuntimeUnits", doc="Unit of time used by maxRuntime", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
var maxRuntimeUnits: java.util.concurrent.TimeUnit = _

/** Type of read downsampling to employ at a given locus */
@Argument(fullName="downsampling_type", shortName="dt", doc="Type of read downsampling to employ at a given locus", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="downsample_to_fraction", shortName="dfrac", doc="Fraction of reads to downsample to", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="downsample_to_fractionFormat", shortName="", doc="Format string for downsample_to_fraction", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
var downsample_to_fractionFormat: String = "%s"

/** Target coverage threshold for downsampling to coverage */
@Argument(fullName="downsample_to_coverage", shortName="dcov", doc="Target coverage threshold for downsampling to coverage", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="baq", shortName="baq", doc="Type of BAQ calculation to apply in the engine", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
var baq: org.broadinstitute.gatk.utils.baq.BAQ.CalculationMode = _

/** BAQ gap open penalty */
@Argument(fullName="baqGapOpenPenalty", shortName="baqGOP", doc="BAQ gap open penalty", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="baqGapOpenPenaltyFormat", shortName="", doc="Format string for baqGapOpenPenalty", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
var baqGapOpenPenaltyFormat: String = "%s"

/** Reduce NDN elements in CIGAR string */
@Argument(fullName="refactor_NDN_cigar_string", shortName="fixNDN", doc="Reduce NDN elements in CIGAR string", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="fix_misencoded_quality_scores", shortName="fixMisencodedQuals", doc="Fix mis-encoded base quality scores", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="allow_potentially_misencoded_quality_scores", shortName="allowPotentiallyMisencodedQuals", doc="Ignore warnings about base quality score encoding", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="useOriginalQualities", shortName="OQ", doc="Use the base quality scores from the OQ tag", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="defaultBaseQualities", shortName="DBQ", doc="Assign a default base quality", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="performanceLog", shortName="PF", doc="Write GATK runtime performance log to this file", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Input(fullName="BQSR", shortName="BQSR", doc="Input covariates table file for on-the-fly base quality score recalibration", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
var BQSR: File = _

/** Quantize quality scores to a given number of levels (with -BQSR) */
@Argument(fullName="quantize_quals", shortName="qq", doc="Quantize quality scores to a given number of levels (with -BQSR)", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="static_quantized_quals", shortName="SQQ", doc="Use static quantized quality scores to a given number of levels (with -BQSR)", required=false, exclusiveOf="quantize_quals", otherArgumentRequired="", validation="")
...
@Argument(fullName="round_down_quantized", shortName="RDQ", doc="Round quals down to nearest quantized qual", required=false, exclusiveOf="quantize_quals", otherArgumentRequired="", validation="")
...
@Argument(fullName="disable_indel_quals", shortName="DIQ", doc="Disable printing of base insertion and deletion tags (with -BQSR)", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="emit_original_quals", shortName="EOQ", doc="Emit the OQ tag with the original base qualities (with -BQSR)", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="preserve_qscores_less_than", shortName="preserveQ", doc="Don't recalibrate bases with quality scores less than this threshold (with -BQSR)", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="globalQScorePrior", shortName="globalQScorePrior", doc="Global Qscore Bayesian prior to use for BQSR", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
var globalQScorePrior: Option[Double] = None

/** Format string for globalQScorePrior */
@Argument(fullName="globalQScorePriorFormat", shortName="", doc="Format string for globalQScorePrior", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
var globalQScorePriorFormat: String = "%s"

/** How strict should we be with validation */
@Argument(fullName="validation_strictness", shortName="S", doc="How strict should we be with validation", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="remove_program_records", shortName="rpr", doc="Remove program records from the SAM header", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="keep_program_records", shortName="kpr", doc="Keep program records in the SAM header", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="sample_rename_mapping_file", shortName="sample_rename_mapping_file", doc="Rename sample IDs on-the-fly at runtime using the provided mapping file", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
var sample_rename_mapping_file: File = _

/** Enable unsafe operations: nothing will be checked at runtime */
@Argument(fullName="unsafe", shortName="U", doc="Enable unsafe operations: nothing will be checked at runtime", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="disable_auto_index_creation_and_locking_when_reading_rods", shortName="disable_auto_index_creation_and_locking_when_reading_rods", doc="Disable both auto-generation of index files and index file locking", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
var disable_auto_index_creation_and_locking_when_reading_rods: Boolean = _

/** Don't include the command line in the VCF header */
@Argument(fullName="no_cmdline_in_header", shortName="no_cmdline_in_header", doc="Don't include the command line in the VCF header", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
var no_cmdline_in_header: Boolean = _

/** Output sites-only VCF */
@Argument(fullName="sites_only", shortName="sites_only", doc="Output sites-only VCF", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
var sites_only: Boolean = _

/** Always output all the records in VCF FORMAT fields, even if some are missing */
@Argument(fullName="never_trim_vcf_format_field", shortName="writeFullFormat", doc="Always output all the records in VCF FORMAT fields, even if some are missing", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="bcf", shortName="bcf", doc="Force BCF output, regardless of the file's extension", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
var bcf: Boolean = _

/** Compression level to use for writing BAM files (0 - 9, higher is more compressed) */
@Argument(fullName="bam_compression", shortName="compress", doc="Compression level to use for writing BAM files (0 - 9, higher is more compressed)", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="simplifyBAM", shortName="simplifyBAM", doc="Strip down read content and tags", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
var simplifyBAM: Boolean = _

/** Turn off on-the-fly creation of indices for output BAM/CRAM files */
@Argument(fullName="disable_bam_indexing", shortName="", doc="Turn off on-the-fly creation of indices for output BAM/CRAM files", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
var disable_bam_indexing: Boolean = _

/** Enable on-the-fly creation of md5s for output BAM files. */
@Argument(fullName="generate_md5", shortName="", doc="Enable on-the-fly creation of md5s for output BAM files.", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
var generate_md5: Boolean = _

/** Number of data threads to allocate to this analysis */
@Argument(fullName="num_threads", shortName="nt", doc="Number of data threads to allocate to this analysis", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="num_cpu_threads_per_data_thread", shortName="nct", doc="Number of CPU threads to allocate per data thread", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="num_io_threads", shortName="nit", doc="Number of given threads to allocate to BAM IO", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="monitorThreadEfficiency", shortName="mte", doc="Enable threading efficiency monitoring", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="num_bam_file_handles", shortName="bfh", doc="When using IO threads, total number of BAM file handles to keep open simultaneously", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Input(fullName="read_group_black_list", shortName="rgbl", doc="Exclude read groups based on tags", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="pedigree", shortName="ped", doc="Pedigree files for samples", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="pedigreeString", shortName="pedString", doc="Pedigree string for samples", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="pedigreeValidationType", shortName="pedValidationType", doc="Validation strictness for pedigree", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="allow_intervals_with_unindexed_bam", shortName="", doc="Allow interval processing with an unsupported BAM/CRAM", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
var allow_intervals_with_unindexed_bam: Boolean = _

/** Write a BCF copy of the output VCF */
@Argument(fullName="generateShadowBCF", shortName="generateShadowBCF", doc="Write a BCF copy of the output VCF", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
var generateShadowBCF: Boolean = _

/** Type of IndexCreator to use for VCF/BCF indices */
@Argument(fullName="variant_index_type", shortName="variant_index_type", doc="Type of IndexCreator to use for VCF/BCF indices", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
...
@Argument(fullName="variant_index_parameter", shortName="variant_index_parameter", doc="Parameter to pass to the VCF/BCF IndexCreator", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
var variant_index_parameter: Option[Int] = None

/** Reference window stop */
@Argument(fullName="reference_window_stop", shortName="ref_win_stop", doc="Reference window stop", required=false, exclusiveOf="", otherArgumentRequired="", validation="")
